...
shortcuts:
  - name: Paper
    link: /assets/pdf/projects/mcm-2023-c.pdf
  - name: Code
    link: https://github.com/Charlie-XIAO/MCM23-Wordle-ML
  - name: Certificate
    link: /assets/pdf/projects/mcm-2023-c-certificate.pdf
...
<div class="row mt-3">
  <div class="col-sm mt-3 mt-md-0">
    {% include figure.html
      path="assets/img/mcm-23-c/time-series.png"
...
<div class="row mt-3">
  <div class="col-sm mt-3 mt-md-0">
    {% include figure.html
      path="assets/img/mcm-23-c/arima.png"
      class="img-fluid rounded z-depth-1"
      zoomable=true
    %}
  </div>
  <div class="col-sm mt-3 mt-md-0">
    {% include figure.html
      path="assets/img/mcm-23-c/nonlinear.png"
      class="img-fluid rounded z-depth-1"
      zoomable=true
    %}
  </div>
...
<div class="row mt-3">
  <div class="col-sm mt-3 mt-md-0">
    {% include figure.html
      path="assets/img/mcm-23-c/pearson.png"
      class="img-fluid rounded z-depth-1"
      zoomable=true
    %}
  </div>
  <div class="col-sm mt-3 mt-md-0">
    {% include figure.html
      path="assets/img/mcm-23-c/distr-pred.png"
      class="img-fluid rounded z-depth-1"
      zoomable=true
    %}
  </div>
...
<div class="row mt-3">
  <div class="col-sm mt-3 mt-md-0">
    {% include figure.html
      path="assets/img/mcm-23-c/kmeans.png"
      class="img-fluid rounded z-depth-1"
      zoomable=true
    %}
  </div>
